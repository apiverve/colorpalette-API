...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/colorpalette',
        'Source': 'https://github.com/apiverve/colorpalette-api',
        'Bug Tracker': 'https://github.com/apiverve/colorpalette-api/issues'
    },
    classifiers=[
